...
<html>
    <head>
        ...
        <?php
	        ...
	        echo $this->Html->css(array('bootstrap', 'font-awesome', 'main', 'fineuploader'));
    ...
    <body>
		...
		<div id="wrapper">
	            		...
	            		<ul class="list-inline pull-right">
	            			<?php  if(AuthComponent::user('id')):?>
		            			...
		            			<?php if(in_array(AuthComponent::user('role_id'), Configure::read('Role.Backoffice'))) : ?>
		            				<li><?php echo $this->Html->link(__('Dashboard'),array('controller'=>'admins','action'=>'home', 'backoffice' => true),array());?></li>
		            			<?php else : ?>
	    	...
	    	<div class="container">
	            ...
	            <section class="content">
	            	<div class="container flash_message_display">
	            		<?php echo $this->Session->flash('auth'); ?>
	                	<?php echo $this->Session->flash(); ?> 
	            	</div>
	    			<article class="col-md-9" id="left_panel">
						<div class="row">
						    <section class="col-md-3" id="leftside-bar">
						    	<?php echo $this->element('left_category_list', array('ul_id_name' => 'left_category_list')); ?>
						    </section>
						    <?php echo $this->fetch('content'); ?>
						</div>
					</article>
	    			<?php echo $this->element('question_poll_create'); ?>
	            </section><!-- /.content -->
        ...
        <?php 
            ...
            echo $this->Html->script(array('main', 'common', 'jquery.fineuploader'), array('inline' => true));
