...
<div class="row">
    <div class="col-sm-12">
        <ul class="nav nav-pills">
            <li><?php echo $this->Html->link(__('Site Users'),array('controller'=>'users','action'=>'index', 'backoffice' => true),array("role"=>"button", "class"=>"btn btn-link"));?></li> 
            <li class="active"><?php echo $this->Html->link(__('Admins'),array('controller'=>'users','action'=>'admins', 'backoffice' => true),array("role"=>"button", "class"=>"btn btn-link"));?></li> 
        </ul>
    </div>
</div>
<?php endif; ?>
    ...
    <div class="panel-body"> 
        <div class="table-responsive">
            <table cellpadding="0" cellspacing="0"  class="table table-bordered">
                <thead>
                    <tr>
                        <th class="text-center col-md-1"><?php echo __('Admin Id'); ?></th>
