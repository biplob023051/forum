		...
		<?php echo $this->Form->create('Question', array(
            ...
            'novalidate'=>'novalidate'
             ...
             <?php
                ...
                echo $this->Form->input('title', array('type' => 'text', 'label'=>array('text'=>__('Title')), 'placeholder' => __('Enter poll title')));
                foreach ($this->request->data['QuestionOption'] as $key => $option) {
                    echo $this->Form->input('QuestionOption.'.$key.'.id', array('type' => 'hidden'));
                    echo $this->Form->input('QuestionOption.'.$key.'.text', array('type' => 'text', 'label'=>array('text'=>__('Option ') . ($key+1)), 'placeholder' => __('Enter poll title')));
                }
            ...
            <div class="form-group">
            	<div class="col col-sm-7 col-sm-offset-3"> 
                    <?php echo $this->Html->link(__('BACK'),array('controller'=>'questions','action'=>'polls', 'backoffice' => true),array('class'=>'btn btn-danger'));?>
