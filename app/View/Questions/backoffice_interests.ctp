					...
					<?php $i = 0; foreach ($questions as $question): $i++; ?>
                        <tr>
                            ...
                            <td class="text-center" nowrap="nowrap">
                                <?php if($question['Question']['isactive']):?>
                            ...
                            <td class="text-center" nowrap="nowrap">
                                <?php echo $this->Form->postLink(__('REMOVE'), array('action' => 'remove_interest', md5($question['Question']['id']),'?'=>array('redirect_url'=>urlencode(Router::reverse($this->request, true)))),array('class'=>'btn btn-danger btn-xs','escape'=>false), __('Are you sure that you want to remove this interest?', trim($question['Question']['id']))); ?>
                            </td>
                        </tr>
                    <?php endforeach; ?>
                </tbody>
