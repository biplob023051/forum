 ...
 *	Site parameters
 */
Configure::write('Site.Name','Forum');
...
Configure::write('Routing.prefixes', array('backoffice', 'member'));

Configure::write('Recaptcha.publicKey', '6LdvdSYTAAAAAADLtE7hhd4vaMCXzaNmUHtbFy5j');
Configure::write('Recaptcha.privateKey', '6LdvdSYTAAAAAMAjyr1M8seDSIfhGMH2kkqKoJmw');

// define constants variable
define('AVATAR_WIDTH', 300);
define('AVATAR_HEIGHT', 300);
